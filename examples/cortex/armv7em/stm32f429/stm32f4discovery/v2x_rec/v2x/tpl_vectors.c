...
extern FUNC(void, OS_CODE) EXTI0_IRQ_Handler(P2CONST(void, OS_APPL_DATA, AUTOMATIC));
extern FUNC(void, OS_CODE) TIM4_IRQ_Handler(P2CONST(void, OS_APPL_DATA, AUTOMATIC));

/* Interrupt table vector */

__attribute__ ((section(".isr_vector"))) CONST(tpl_it_handler, AUTOMATIC) tpl_it_vectors[107] = {
  ...
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)EXTI0_IRQ_Handler,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
  ...
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)TIM4_IRQ_Handler,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
