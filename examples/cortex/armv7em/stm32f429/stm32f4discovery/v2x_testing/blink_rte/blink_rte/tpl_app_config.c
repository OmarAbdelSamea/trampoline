...
/* Task blink_rte identifier */
#define blink_rte_id 0
CONST(TaskType, AUTOMATIC) blink_rte = blink_rte_id;
 ...
 */
/*-----------------------------------------------------------------------------
 * Task blink_rte descriptor
 */
#define APP_Task_blink_rte_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task blink_rte function prototype
 */

FUNC(void, OS_APPL_CODE) blink_rte_function(void);
 ...
 */
/*
 * Task blink_rte stack
 */
#define APP_Task_blink_rte_START_SEC_STACK
#include "tpl_memmap.h"
VAR(tpl_stack_word, OS_APPL_DATA) blink_rte_stack_zone[300/sizeof(tpl_stack_word)];
#define APP_Task_blink_rte_STOP_SEC_STACK
#include "tpl_memmap.h"

#define blink_rte_STACK {blink_rte_stack_zone, 300}

/*
 * Task blink_rte context
 */
#define OS_START_SEC_VAR_NOINIT_32BIT
#include "tpl_memmap.h"
VAR(arm_core_context, OS_VAR) blink_rte_int_context;

#define blink_rte_CONTEXT &blink_rte_int_context
...
/*
 * Static descriptor of task blink_rte
 */
CONST(tpl_proc_static, OS_CONST) blink_rte_task_stat_desc = {
  /* context                  */  blink_rte_CONTEXT,
  /* stack                    */  blink_rte_STACK,
  /* entry point (function)   */  blink_rte_function,
  /* internal ressource       */  NULL,
  /* task id                  */  blink_rte_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
#endif
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task blink_rte
 */
VAR(tpl_proc, OS_VAR) blink_rte_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
 ...
 *
 * This alarm does the activation of task blink_rte
 */
