...
/* Task Task_prescan identifier */
#define Task_prescan_id 0
CONST(TaskType, AUTOMATIC) Task_prescan = Task_prescan_id;

/* Task Task_receive identifier */
#define Task_receive_id 1
CONST(TaskType, AUTOMATIC) Task_receive = Task_receive_id;
 ...
 */
/*-----------------------------------------------------------------------------
 * Task Task_prescan descriptor
 */
#define APP_Task_Task_prescan_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task Task_prescan function prototype
 */

FUNC(void, OS_APPL_CODE) Task_prescan_function(void);
 ...
 */
/*
 * Task Task_prescan stack
 */
#define APP_Task_Task_prescan_START_SEC_STACK
#include "tpl_memmap.h"
VAR(tpl_stack_word, OS_APPL_DATA) Task_prescan_stack_zone[1000/sizeof(tpl_stack_word)];
#define APP_Task_Task_prescan_STOP_SEC_STACK
#include "tpl_memmap.h"

#define Task_prescan_STACK {Task_prescan_stack_zone, 1000}

/*
 * Task Task_prescan context
 */
#define OS_START_SEC_VAR_NOINIT_32BIT
#include "tpl_memmap.h"
VAR(arm_core_context, OS_VAR) Task_prescan_int_context;

#define Task_prescan_CONTEXT &Task_prescan_int_context
...
/*
 * Resources used by task Task_prescan
 *
 * INTERNAL_RES_SCHEDULER
 */

/*
 * Static descriptor of task Task_prescan
 */
CONST(tpl_proc_static, OS_CONST) Task_prescan_task_stat_desc = {
  /* context                  */  Task_prescan_CONTEXT,
  /* stack                    */  Task_prescan_STACK,
  /* entry point (function)   */  Task_prescan_function,
  /* internal ressource       */  &INTERNAL_RES_SCHEDULER,
  /* task id                  */  Task_prescan_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
#endif
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task Task_prescan
 */
VAR(tpl_proc, OS_VAR) Task_prescan_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
...
/*-----------------------------------------------------------------------------
 * Task Task_receive descriptor
 */
#define APP_Task_Task_receive_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task Task_receive function prototype
 */

FUNC(void, OS_APPL_CODE) Task_receive_function(void);
 ...
 */
/*
 * Task Task_receive stack
 */
#define APP_Task_Task_receive_START_SEC_STACK
#include "tpl_memmap.h"
VAR(tpl_stack_word, OS_APPL_DATA) Task_receive_stack_zone[30000/sizeof(tpl_stack_word)];
#define APP_Task_Task_receive_STOP_SEC_STACK
#include "tpl_memmap.h"

#define Task_receive_STACK {Task_receive_stack_zone, 30000}

/*
 * Task Task_receive context
 */
#define OS_START_SEC_VAR_NOINIT_32BIT
#include "tpl_memmap.h"
VAR(arm_core_context, OS_VAR) Task_receive_int_context;

#define Task_receive_CONTEXT &Task_receive_int_context
...
/*
 * Resources used by task Task_receive
 *
 * INTERNAL_RES_SCHEDULER
 */

/*
 * Static descriptor of task Task_receive
 */
CONST(tpl_proc_static, OS_CONST) Task_receive_task_stat_desc = {
  /* context                  */  Task_receive_CONTEXT,
  /* stack                    */  Task_receive_STACK,
  /* entry point (function)   */  Task_receive_function,
  /* internal ressource       */  &INTERNAL_RES_SCHEDULER,
  /* task id                  */  Task_receive_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
#endif
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task Task_receive
 */
VAR(tpl_proc, OS_VAR) Task_receive_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
...
#define OS_START_SEC_CODE
#include "tpl_memmap.h"
extern FUNC(void, OS_CODE) isr_nrf_function(void);
